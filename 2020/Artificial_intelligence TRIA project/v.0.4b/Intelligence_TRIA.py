    ...
    for i in range(len(command_result)):
        ...
        try:
            if command_result[i] == '날' and command_result[i + 1] == '씨' or \
                ...
                command_result[i] == '기' and command_result[i + 1] == '온':
        ...
        try:
            if command_result[i] == '지' and command_result[i + 1] == '금' or \
                command_result[i] == '년' or \
                command_result[i] == '월' or \
                command_result[i] == '시' or \
                command_result[i] == '분' or \
                ...
                time(command_result[i], location_1)
                plag = + 1
                break
        except IndexError:
            pass
