    ...
    for i in range(len(command_result_1)):
        try:
            if command_result_1[i] == '특' and command_result_1[i + 1] == '별' and command_result_1[i + 2] == '시' or \
                ...
                command_result_1[i] == '특' and command_result_1[i + 1] == '별' and command_result_1[i + 2] == '자' and command_result_1[i + 3] == '치' and command_result_1[i + 4] == '시' or \
                command_result_1[i] == '도' or \
                command_result_1[i] == '특' and command_result_1[i + 1] == '별' and command_result_1[i + 2] == '자' and command_result_1[i + 3] == '치' and command_result_1[i + 4] == '도' or \
                command_result_1[i] == '시':
                while command_result_1[i - 1] != ' ':
                    location_2_ = str(command_result_1[i - 1]) + location_2_
                    i = i - 1
                    print(location_2_)
        except IndexError:
            pass
        ...
        try:
            if command_result_1[i] == '시' or command_result_1[i] == '군' or command_result_1[i] == '구':
                pass
        except IndexError:
            pass
