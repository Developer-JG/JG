...
class select:
    def __init__(self, plag, name, search_history):
        self.plag = plag
        self.name = name
        self.search_history = []
...
image_0 = pygame.transform.scale(image, (500, 500))
...
U_image_1 = pygame.image.load("SNU.png")
U_image_1_1 = pygame.transform.scale(U_image_1, (420, 420))

U_image_2 = pygame.image.load("YU.png")
U_image_2_1 = pygame.transform.scale(U_image_2, (420, 420))

U_image_3 = pygame.image.load("KU.png")
U_image_3_1 = pygame.transform.scale(U_image_3, (420, 420))

U_image_4 = pygame.image.load("SU.png")
U_image_4_1 = pygame.transform.scale(U_image_4, (420, 420))

U_image_5 = pygame.image.load("SKKU.png")
U_image_5_1 = pygame.transform.scale(U_image_5, (420, 420))

U_image_6 = pygame.image.load("HYU.png")
U_image_6_1 = pygame.transform.scale(U_image_6, (420, 420))
...
font_input_history_1 = pygame.font.Font("BinggraeTaom-Bold.ttf", 30)
font_input_history_2 = pygame.font.Font("BinggraeTaom-Bold.ttf", 30)
font_input_history_3 = pygame.font.Font("BinggraeTaom-Bold.ttf", 20)
...
font_input_search_6 = pygame.font.Font("BinggraeTaom-Bold.ttf", 40)
font_input_information_1 = pygame.font.Font("BinggraeTaom-Bold.ttf", 50)
font_input_information_2 = pygame.font.Font("BinggraeTaom-Bold.ttf", 40)
font_input_information_3 = pygame.font.Font("BinggraeTaom-Bold.ttf", 30)
font_input_information_4 = pygame.font.Font("BinggraeTaom-Bold.ttf", 25)
font_input_information_5 = pygame.font.Font("BinggraeTaom-Bold.ttf", 35)
font_input_information_6 = pygame.font.Font("BinggraeTaom-Bold.ttf", 15)
font_input_cradit_1 = pygame.font.Font("BinggraeTaom-Bold.ttf", 90)
font_input_cradit_2 = pygame.font.Font("BinggraeTaom-Bold.ttf", 40)
font_input_cradit_3 = pygame.font.Font("BinggraeTaom-Bold.ttf", 50)
font_input_cradit_4 = pygame.font.Font("BinggraeTaom-Bold.ttf", 30)
font_input_cradit_5 = pygame.font.Font("BinggraeTaom-Bold.ttf", 20)
font_input_cradit_6 = pygame.font.Font("BinggraeTaom-Bold.ttf", 10)
...
def cradit():
    ...
    while input_log.plag == 24:
        ...
        text_1 = font_input_subscript.render("POWERED BY PYTHON" + python_ver + " | MADE BY JG IN SEOUL", True, sky_blue)
        ...
        cradit_text_1 = font_input_cradit_1.render("대학가자", True, blue)
        rect_cradit_text_1 = cradit_text_1.get_rect()
        rect_cradit_text_1.bottomright = (765, 320)
        screen.blit(cradit_text_1, rect_cradit_text_1)

        cradit_text_2 = font_input_cradit_2.render("(" + ver + ")", True, blue)
        rect_cradit_text_2 = cradit_text_2.get_rect()
        rect_cradit_text_2.bottomleft = (765, 310)
        screen.blit(cradit_text_2, rect_cradit_text_2)

        cradit_text_3 = font_input_cradit_3.render("Maker : Developer_JG", True, blue)
        rect_cradit_text_3 = cradit_text_3.get_rect()
        rect_cradit_text_3.topleft = (430, 330)
        screen.blit(cradit_text_3, rect_cradit_text_3)

        cradit_text_4 = font_input_cradit_4.render("https://github.com/Developer-JG/", True, gray)
        rect_cradit_text_4 = cradit_text_4.get_rect()
        rect_cradit_text_4.topleft = (445, 420)
        screen.blit(cradit_text_4, rect_cradit_text_4)

        cradit_text_5 = font_input_cradit_5.render("모집단위명 및 선발인원은 각 대학 학생정원조정 및", True, gray)
        rect_cradit_text_5 = cradit_text_5.get_rect()
        rect_cradit_text_5.center = (screen_width / 2, 600)
        screen.blit(cradit_text_5, rect_cradit_text_5)

        cradit_text_6 = font_input_cradit_5.render("한국대학교육협의회의 심의결과에 따라 변경될 수 있습니다.", True, gray)
        rect_cradit_text_6 = cradit_text_6.get_rect()
        rect_cradit_text_6.center = (screen_width / 2, 625)
        screen.blit(cradit_text_6, rect_cradit_text_6)

        cradit_text_7 = font_input_cradit_6.render("TM and Copyright 2021 Developer_JG. all rights reserved", True, gray)
        rect_cradit_text_7 = cradit_text_7.get_rect()
        rect_cradit_text_7.topright = (995, 740)
        screen.blit(cradit_text_7, rect_cradit_text_7)

        pygame.display.update()


def information(input_list_count):
    input_log.plag = 22
    while input_log.plag == 22:
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:
                pos = pygame.mouse.get_pos()
                input_log.plag = 22
        ...
        if input_list_count[6] == 'SNU':
            screen.blit(U_image_1_1, [290, 80])
        if input_list_count[6] == 'YU':
            screen.blit(U_image_2_1, [290, 80])
        if input_list_count[6] == 'KU':
            screen.blit(U_image_3_1, [290, 80])
        if input_list_count[6] == 'SU':
            screen.blit(U_image_4_1, [290, 80])
        if input_list_count[6] == 'SKKU':
            screen.blit(U_image_5_1, [290, 80])
        if input_list_count[6] == 'HYU':
            screen.blit(U_image_6_1, [290, 80])

        screen.blit(image_3, [850, 0])
        pygame.draw.polygon(screen, blue, [[0, 0], [0, 250], [250, 0]], 0)
        pygame.draw.line(screen, black, [0, 757], [1000, 757], 3)
        pygame.draw.rect(screen, gray, [0, 760, 1000, 40], 0)
        ...
        information_text_1 = font_input_information_1.render(input_list_count[0] + "   ( " + input_list_count[1] + " )", True, black)
        rect_information_text_1 = information_text_1.get_rect()
        rect_information_text_1.center = (screen_width / 2, 550)
        screen.blit(information_text_1, rect_information_text_1)

        text = ("[ " + input_list_count[3] + " ]  ( " + input_list_count[4] + " )  : " + input_list_count[2])
        if len(text) <= 22:
            information_text_2 = font_input_information_2.render("[ " + input_list_count[3] + " ]  ( " + \
                                                                 input_list_count[4] + " )  : " + input_list_count[2], True, black)
        elif len(text) <= 42:
            information_text_2 = font_input_information_3.render("[ " + input_list_count[3] + " ]  ( " + \
                                                                 input_list_count[4] + " )  : " + input_list_count[2], True, black)
        else:
            information_text_2 = font_input_information_4.render("[ " + input_list_count[3] + " ]  ( " + \
                                                                 input_list_count[4] + " )  : " + input_list_count[2], True, black)

        rect_information_text_2 = information_text_2.get_rect()
        rect_information_text_2.center = (screen_width / 2, 620)
        screen.blit(information_text_2, rect_information_text_2)

        information_text_3 = font_input_information_5.render("정원 : " + input_list_count[5] + " 명", True, black)
        rect_information_text_3 = information_text_3.get_rect()
        rect_information_text_3.center = (screen_width / 2, 680)
        screen.blit(information_text_3, rect_information_text_3)

        information_text_4 = font_input_information_6.render("[나가려면 아무키나 누르세요.]", True, gray)
        rect_information_text_4 = information_text_4.get_rect()
        rect_information_text_4.center = (screen_width / 2, 725)
        screen.blit(information_text_4, rect_information_text_4)
    ...
    if input_log.plag == 23:
        input_log.plag = 17


def search(input):
    if input_log.plag != 26:
        input_log.plag = 17

    if input not in input_log.search_history:
        input_list = list(input)
        if len(input_list) <= 16:
            input_log.search_history.insert(0, input)

    if len(input_log.search_history) == 6:
        input_log.search_history.remove(input_log.search_history[-1])
    ...
    while 17 <= input_log.plag <= 19:
        ...
        if len(search_list) == 0:
            search_error_text = font_input_search_6.render("검색결과가 없습니다.", True, gray)
        ...
        if search_plag != 0:
            information(search_list[((now_page - 1) * show_count) + (search_plag - 1)])
...
def main():
    ...
    while input_log.plag == 16:
        ...
        if len(input_log.search_history) == 0:
        ...
        if len(input_log.search_history) != 0:
            pygame.draw.rect(screen, beige, [530, 150, 320, 45 + (55 * len(input_log.search_history))], 0)
            pygame.draw.line(screen, blue, [530, 200], [850, 200], 3)

            main_history_text_1 = font_input_history_1.render("검색기록", True, gray)
            rect_main_history_text_1 = main_history_text_1.get_rect()
            rect_main_history_text_1.midtop = ((screen_width / 2) + 190, 155)
            screen.blit(main_history_text_1, rect_main_history_text_1)

            history_plag = 0
            if len(input_log.search_history) >= 1:
                if len(input_log.search_history[0]) <= 10:
                    main_history_text_2 = font_input_history_2.render(input_log.search_history[0], True, gray)
                else:
                    main_history_text_2 = font_input_history_3.render(input_log.search_history[0], True, gray)
                    history_plag += 1
                rect_main_history_text_2 = main_history_text_2.get_rect()
                if history_plag == 0:
                    rect_main_history_text_2.midtop = ((screen_width / 2) + 190, 205)
                elif history_plag == 1:
                    rect_main_history_text_2.midtop = ((screen_width / 2) + 190, 210)
                screen.blit(main_history_text_2, rect_main_history_text_2)

            history_plag = 0
            if len(input_log.search_history) >= 2:
                if len(input_log.search_history[1]) <= 10:
                    main_history_text_2 = font_input_history_2.render(input_log.search_history[1], True, gray)
                else:
                    main_history_text_2 = font_input_history_3.render(input_log.search_history[1], True, gray)
                    history_plag += 1
                rect_main_history_text_2 = main_history_text_2.get_rect()
                if history_plag == 0:
                    rect_main_history_text_2.midtop = ((screen_width / 2) + 190, 260)
                elif history_plag == 1:
                    rect_main_history_text_2.midtop = ((screen_width / 2) + 190, 265)
                screen.blit(main_history_text_2, rect_main_history_text_2)

            history_plag = 0
            if len(input_log.search_history) >= 3:
                if len(input_log.search_history[2]) <= 10:
                    main_history_text_2 = font_input_history_2.render(input_log.search_history[2], True, gray)
                else:
                    main_history_text_2 = font_input_history_3.render(input_log.search_history[2], True, gray)
                    history_plag += 1
                rect_main_history_text_2 = main_history_text_2.get_rect()
                if history_plag == 0:
                    rect_main_history_text_2.midtop = ((screen_width / 2) + 190, 315)
                elif history_plag == 1:
                    rect_main_history_text_2.midtop = ((screen_width / 2) + 190, 320)
                screen.blit(main_history_text_2, rect_main_history_text_2)

            history_plag = 0
            if len(input_log.search_history) >= 4:
                if len(input_log.search_history[3]) <= 10:
                    main_history_text_2 = font_input_history_2.render(input_log.search_history[3], True, gray)
                else:
                    main_history_text_2 = font_input_history_3.render(input_log.search_history[3], True, gray)
                    history_plag += 1
                rect_main_history_text_2 = main_history_text_2.get_rect()
                if history_plag == 0:
                    rect_main_history_text_2.midtop = ((screen_width / 2) + 190, 370)
                elif history_plag == 1:
                    rect_main_history_text_2.midtop = ((screen_width / 2) + 190, 375)
                screen.blit(main_history_text_2, rect_main_history_text_2)

            history_plag = 0
            if len(input_log.search_history) >= 5:
                if len(input_log.search_history[3]) <= 10:
                    main_history_text_2 = font_input_history_2.render(input_log.search_history[4], True, gray)
                else:
                    main_history_text_2 = font_input_history_3.render(input_log.search_history[4], True, gray)
                    history_plag += 1
                rect_main_history_text_2 = main_history_text_2.get_rect()
                if history_plag == 0:
