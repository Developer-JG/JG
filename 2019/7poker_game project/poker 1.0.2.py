...
print ()
print ("[The python '7 poker' project]")
print ()
...
while plag >= 0:
    while plag > 1:
            ...
            if plag1 == 1:
                ...
                if ans == 3:
                    if pm < 20:
                        ...
                        print ("올인은 남은돈이 20 이하일때만 할 수 있습니다. 남은플레이어 돈:",pm)
                        print ("판돈을 올립니다. 레이즈")
                        print ("얼마나 베팅하시겠습니까? (최대 10)")
                        q = input("=")
                        ans1 = int(q)
            ...
            if plag4 == 2:
                ...
                if ans == 3:
                    if pm < 30:
                        ...
                        print ("올인은 남은돈이 30 이하일때만 할 수 있습니다. 남은플레이어 돈:",pm)
                        print ("판돈을 올립니다. 레이즈")
                        print ("얼마나 베팅하시겠습니까? (최대 10)")
                        q = input("=")
                        ans7 = int(q)
        ...
        if plag2 == 0:
            ...
            print ()
            print ("네번째 턴!")
            print ("com1의 패: [",ccdp1, ccdn1,"] [ ? ? ] [ ? ? ] [",ccdp4, ccdn4,"] [",ccdp5,ccdn5,"][",ccdp6,ccdn6,"]")
            print ("플래이어의 패: [",pcdp1, pcdn1,"] [",pcdp2, pcdn2,"] [",pcdp3, pcdn3,"] [",pcdp4,pcdn4,"] [",pcdp5,pcdn5,"][",pcdp6,pcdn6,"]")
            print ()
            ...
            if plag7 == 1:
                ...
                if ans == 3:
                    if pm < 50:
                        ...
                        print ("올인은 남은돈이 50 이하일때만 할 수 있습니다. 남은플레이어 돈:",pm)
                        print ("판돈을 올립니다. 레이즈")
                        print ("얼마나 베팅하시겠습니까? (최대 10)")
                        q = input("=")
                        ans8 = int(q)
                ...
                if plag2 == 0:
                    ...
                    bet = bet + ans9
                    pm = pm - ans9
                    print ("com1이 ",ans9,"배팅 하였습니다. 총 배팅:",bet)
        ...
        if plag2 == 0:
            ...
            print ()
            print ("다섯번째 턴!")
            print ("com1의 패: [",ccdp1, ccdn1,"] [ ? ? ] [ ? ? ] [",ccdp4, ccdn4,"] [",ccdp5,ccdn5,"][",ccdp6,ccdn6,"][",ccdp7,ccdn7,"]")
            ...
            num0 = [ccdn1, ccdn4, ccdn5, ccdn6, ccdn7]
            ...
            num01 = [pcdn1, pcdn4, pcdn5, pcdn6, pcdn7]
    
            num01.sort(reverse=True)
            ...
            pet0 = [ccdp1, ccdp4, ccdp5, ccdp6, ccdp7]

            pet0.sort(reverse=True)
            ...
            pet01 = [pcdp1, pcdp4, pcdp5, pcdp6, pcdp7]
    
            pet01.sort(reverse=True)
            ...
            if pet1 == pet2 == pet3 == pet4 == pet5:
                plag11 = 2
                plag10 = plag10 + 1

            if pet01 == pet02 == pet03 == pet04 == pet05:
                plag11 = 2
                plag10 = plag10 + 1
            ...
            if plag11 == 0:
                ...
                if num01 == num02 == num03:
                    plag10 = plag10 + 1
                    plag11 = 1
                if num04 == num02 == num03:
                    plag10 = plag10 + 1
                    plag11 = 1
                if num04 == num05 == num03:
                    plag10 = plag10 + 1
                    plag11 = 1
            ...
            if plag11 == 0:
                ...
                if plag11 == 0:
                    ...
                    if num1 == num01:
                        ...
                        last1 = [kpd1, kpd4, kpd5, kpd6, kpd7]
                
                        last1.sort(reverse=True)
                        ...
                        last2 = [kcd1, kcd4, kcd5, kcd6, kcd7]
                
                        last2.sort(reverse=True)
            ...
            if plag11 == 1:
                ...
                if ans == 3:
                    if pm < 70:
                        ...
                        print ("올인은 남은돈이 70 이하일때만 할 수 있습니다. 남은플레이어 돈:",pm)
                        print ("판돈을 올립니다. 레이즈")
                        print ("얼마나 베팅하시겠습니까? (최대 10)")
                        q = input("=")
                        ans10 = int(q)
                ...
                if plag2 == 0:
                    ...
                    bet = bet + ans10
                    pm = pm - ans10
                    print ("com1이 ",ans10,"배팅 하였습니다. 총 배팅:",bet)
            ...
            if plag11 == 2:
                ...
                if ans == 3:
                    if pm < 20:
                        ...
                        bet = bet + ans10
                        pm = pm - ans10
                        print (ans10,"배팅하셨습니다. 총 배팅:",bet)

        print ()
        q = input("결과를 공개하려면 Space bar")
        print ()
        print ()
        print ()
        print ()
        ...
        if plag2 != 10:
            ...
            if player < computer:
                ...
                last1 = [kpd1, kpd2, kpd3, kpd4, kpd5, kpd6, kpd7]
                ...
                last2 = [kcd1, kcd2, kcd3, kcd4, kcd5, kcd6, kcd7]
